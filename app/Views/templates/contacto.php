              ...
              <?php echo form_open('inicio/enviar_mail', 'class=""'); ?>
                  ...
                  <div class="form-group">
                      <select id="servicio" name="servicio" class="form-control">
                        <option value="sitioWeb" <?php echo ($tipoServicio == 1) ? 'selected' : '';?>>Sitio web</option>
                        <option value="Modificaciones" <?php echo ($tipoServicio == 2) ? 'selected' : '';?>>Modificaciones</option>
                        <option value="sistema" <?php echo ($tipoServicio == 3) ? 'selected' : '';?>>Sistema de información</option>
                        <option value="cursoCodeigniter" <?php echo ($tipoServicio == 4) ? 'selected' : '';?>>Curso de Codeigniter</option>
                      </select>
                  </div>
                  <div class="form-group">
