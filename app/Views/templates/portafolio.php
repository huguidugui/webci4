                  ...
                  <article class="blog-news-single">
                    <div class="blog-news-img">
                      <a href="<?php echo $item->link;?>" target="_blank">
                        <img src="<?php echo base_url();?>assets/images/portfolio/<?php echo $item->imagen;?>" alt="<?php echo $item->alt;?>">
                      </a>
                    </div>
                    <div class="blog-news-title">
                      ...
                      <p>                  
                        <span class="blog-date"><?php echo $item->tipo;?></span>
                      </p>
                      <a class="blog-more-btn" href="<?php echo $item->link;?>">
                        Visitar <i class="fa fa-long-arrow-right"></i>
                      </a>
                    </div>
                  </article>
                </div>
