!(function($) {
  ...
  $(window).scroll(function() {
    if ($(this).scrollTop() > 100) {
      ...
      $('#header a > img').addClass('img-scrolled');
    } else {
      $('#header').removeClass('header-scrolled');
      $('#header a > img').removeClass('img-scrolled');
    }
  });
  ...
  $(".testimonials-carousel").owlCarousel({
    ...
    smartSpeed: 600,
    loop: true,
    autoplayTimeout: 16200,
    items: 1
  });

  $(".yo-mero-carousel").owlCarousel({
    autoplay: true,
    dots: true,
    loop: true,
    items: 1
  ...
  $(".lenguajes-carousel").owlCarousel({
    autoplay: true,
    dots: true,
    loop: true,
    autoHeight: true,
